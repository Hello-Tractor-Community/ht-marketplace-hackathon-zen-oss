...
export default function FiltersPrice({
	...
	return (
		<div className='flex w-full flex-col gap-4'>
			...
			<div className='my-4 grid grid-cols-1 gap-8 md:grid-cols-1'>
				<div className='grid grid-cols-2 gap-3'>
					...
					<div className='col-span-2 flex items-center justify-between space-x-2'>
						<input
							...
							readOnly
							className='bock rounde-lg focus:border-primary-500 focus:ring-primary-500 w-full border border-gray-300 bg-gray-50 p-2.5  text-sm text-gray-900'
						/>
