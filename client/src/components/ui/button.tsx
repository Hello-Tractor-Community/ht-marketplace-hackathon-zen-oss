  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-htractor text-htractor-hibiscus bg-background shadow-sm hover:bg-htractor/5 hover:text-htractor",
        secondary:
          "bg-htractor/5 text-htractor-hibiscus shadow-sm hover:text-white hover:bg-htractor/80",
        ghost: "hover:bg-accent hover:text-accent-foreground text-htractor-hibiscus hover:text-htractor",
        link: "text-htractor underline-offset-4 hover:underline",
      },
      size: {
